...
function to_html($string, $encode=true){
	...
	if(is_string($string)){
		if($action != 'Export' && $action != $ajax_action && $action != 'LeadConvertToEntities' && $action != 'CreatePDF' && $action != 'ConvertAsFAQ' && $_REQUEST['module'] != 'Dashboard' && $action != 'CreateSOPDF'){ // && $_REQUEST['module'] != 'Emails'))
			$doconvert = true;
