...
/**     Function to export all the records from a module
 *      @param  : string $module - current module value
 *		this function accepts a module name as an argument and
 *		returns the CSV file of all the records in the 
...
/**     Function added to convert line breaks to space
 *      @param  : string $str - string with line breaks
 *		this function accepts a string as an argument and
 *		convers the line breaks into space and returns the converted string
 */
...
/**     Function to get all the records from a module as a comma seperated values 
 *      @param  : string $module - current module value
 *		this function accepts a module name as an argument and
 *		returns the records in comma seperated values
 */
