...
<table border="0" cellspacing="0" cellpadding="0" style="margin-top:5;margin-left:2">
  <tr> 
		...
		<form name="calculator">
          ...
          <tr> 
            <td colspan=6><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td width="3" background="$image_path/calc_res_ml.gif"><img src="$image_path/blank.gif"></td>
