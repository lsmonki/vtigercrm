...
InsertLineLbl		: "Čiara",
InsertLine			: "Vložiť vodorovnú �?iara",
...
IncreaseIndent		: "Zvä�?šiť odsadenie",
Undo				: "Späť",
Redo				: "Znovu",
NumberedListLbl		: "Číslovanie",
NumberedList		: "Vložiť/odstrániť �?íslovaný zoznam",
...
CheckboxProp		: "Vlastnosti zaškrtávacieho polí�?ka",
...
Done				: "Dokon�?ené.",
PasteWordConfirm	: "Vyzerá to tak, že vkladaný text je kopírovaný z Wordu. Chcete ho pred vložením vy�?istiť?",
NotCompatiblePaste	: "Tento príkaz je dostupný len v prehliada�?i Internet Explorer verzie 5.5 alebo vyššej. Chcete vložiť text bez vy�?istenia?",
...
PasteErrorPaste	: "Bezpe�?nostné nastavenie Vášho prohehliada�?a nedovoľujú editoru spustiť funkciu pre vloženie textu zo schránky. Prosím vložte text zo schránky pomocou klávesnice (Ctrl+V).",
PasteErrorCut	: "Bezpe�?nostné nastavenie Vášho prohehliada�?a nedovoľujú editoru spustiť funkciu pre vystrihnutie zvoleného textu do schránky. Prosím vystrihnite zvolený text do schránky pomocou klávesnice (Ctrl+X).",
PasteErrorCopy	: "Bezpe�?nostné nastavenie Vášho prohehliada�?a nedovoľujú editoru spustiť funkciu pre kopírovánie zvoleného textu do schránky. Prosím skopírujte zvolený text do schránky pomocou klávesnice (Ctrl+C).",
...
DlgPasteCleanBox		: "Vy�?istiť schránku",
...
DlgSpellNoChanges		: "Kontrola pravopisu dokon�?ená: žiadne slová nezmenené",
DlgSpellOneChange		: "Kontrola pravopisu dokon�?ená: zmenené jedno slovo",
DlgSpellManyChanges		: "Kontrola pravopisu dokon�?ená: zmenených %1 slov",

IeSpellDownload			: "Kontrola pravopisu nie je naištalovaná. Chcete ju hne�? stiahnuť?",
...
DlgLstTypeLRoman	: "Veľké rímske �?íslice (I, II, III)",
...
DlgDocMeIndex		: "Kľú�?ové slová pre indexovanie (oddelené �?iarkou)",
