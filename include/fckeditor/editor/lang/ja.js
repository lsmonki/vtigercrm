...
NoActiveX			: "ã‚¨ãƒ©ãƒ¼ã€?è­¦å‘Šãƒ¡ãƒƒã‚»ãƒ¼ã‚¸ã?ªã?©ã?Œç™ºç”Ÿã?—ã?Ÿå ´å?ˆã€?ãƒ–ãƒ©ã‚¦ã‚¶ãƒ¼ã?®ã‚»ã‚­ãƒ¥ãƒªãƒ†ã‚£è¨­å®šã?«ã‚ˆã‚Šã‚¨ãƒ‡ã‚£ã‚¿ã?®ã?„ã??ã?¤ã?‹ã?®æ©Ÿèƒ½ã?Œåˆ¶é™?ã?•ã‚Œã?¦ã?„ã‚‹å?¯èƒ½æ€§ã?Œã?‚ã‚Šã?¾ã?™ã€‚ã‚»ã‚­ãƒ¥ãƒªãƒ†ã‚£è¨­å®šã?®ã‚ªãƒ—ã‚·ãƒ§ãƒ³ã?§\"ActiveXã‚³ãƒ³ãƒˆãƒ­ãƒ¼ãƒ«ã?¨ãƒ—ãƒ©ã‚°ã‚¤ãƒ³ã?®å®Ÿè¡Œ\"ã‚’æœ‰åŠ¹ã?«ã?™ã‚‹ã?«ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
BrowseServerBlocked : "ã‚µãƒ¼ãƒ?ãƒ¼ãƒ–ãƒ©ã‚¦ã‚¶ãƒ¼ã‚’é–‹ã??ã?“ã?¨ã?Œã?§ã??ã?¾ã?›ã‚“ã?§ã?—ã?Ÿã€‚ãƒ?ãƒƒãƒ—ã‚¢ãƒƒãƒ—ãƒ»ãƒ–ãƒ­ãƒƒã‚¯æ©Ÿèƒ½ã?Œç„¡åŠ¹ã?«ã?ªã?£ã?¦ã?„ã‚‹ã?‹ç¢ºèª?ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
DialogBlocked		: "ãƒ€ã‚¤ã‚¢ãƒ­ã‚°ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã‚’é–‹ã??ã?“ã?¨ã?Œã?§ã??ã?¾ã?›ã‚“ã?§ã?—ã?Ÿã€‚ãƒ?ãƒƒãƒ—ã‚¢ãƒƒãƒ—ãƒ»ãƒ–ãƒ­ãƒƒã‚¯æ©Ÿèƒ½ã?Œç„¡åŠ¹ã?«ã?ªã?£ã?¦ã?„ã‚‹ã?‹ç¢ºèª?ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
...
DlgOpOther			: "&lt;ã??ã?®ä»–&gt;",
DlgInfoTab			: "æƒ…å ±",
DlgAlertUrl			: "URLã‚’æŒ¿å…¥ã?—ã?¦ã??ã? ã?•ã?„",
...
DlgFlashScaleNoBorder	: "å¤–ã?Œè¦‹ã?ˆã?ªã?„æ§˜ã?«æ‹¡å¤§",
...
DlgPasteMsg2	: "ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰(<STRONG>Ctrl+V</STRONG>)ã‚’ä½¿ç”¨ã?—ã?¦ã€?æ¬¡ã?®å…¥åŠ›ã‚¨ãƒªã‚¢å†…ã?§è²¼ã?£ã?¦ã€?<STRONG>OK</STRONG>ã‚’æŠ¼ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
DlgPasteIgnoreFont		: "Fontã‚¿ã‚°ã?®Faceå±žæ€§ã‚’ç„¡è¦–ã?—ã?¾ã?™ã€‚",
DlgPasteRemoveStyles	: "ã‚¹ã‚¿ã‚¤ãƒ«å®šç¾©ã‚’å‰Šé™¤ã?—ã?¾ã?™ã€‚",
DlgPasteCleanBox		: "å…¥åŠ›ã‚¨ãƒªã‚¢ã‚¯ãƒªã‚¢",
...
DlgTemplatesSelMsg	: "ã‚¨ãƒ‡ã‚£ã‚¿ãƒ¼ã?§ä½¿ç”¨ã?™ã‚‹ãƒ†ãƒ³ãƒ—ãƒ¬ãƒ¼ãƒˆã‚’é?¸æŠžã?—ã?¦ã??ã? ã?•ã?„ã€‚<br>(ç?¾åœ¨ã?®ã‚¨ãƒ‡ã‚£ã‚¿ã?®å†…å®¹ã?¯å¤±ã‚?ã‚Œã?¾ã?™):",
DlgTemplatesLoading	: "ãƒ†ãƒ³ãƒ—ãƒ¬ãƒ¼ãƒˆä¸€è¦§èª­ã?¿è¾¼ã?¿ä¸­. ã?—ã?°ã‚‰ã??ã?Šå¾…ã?¡ã??ã? ã?•ã?„...",
DlgTemplatesNoTpl	: "(ãƒ†ãƒ³ãƒ—ãƒ¬ãƒ¼ãƒˆã?Œå®šç¾©ã?•ã‚Œã?¦ã?„ã?¾ã?›ã‚“)",
