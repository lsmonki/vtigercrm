...
if (is_admin($current_user)) $xtpl->assign("ADMIN_LINK", "<a class='toplink' href='index.php?module=Administration&action=index'><img src='".$image_path."/admin.gif' hspace='3' align='absmiddle' border='0'>".$app_strings['LBL_ADMIN']."</a>&nbsp;<a class='toplink' href='index.php?module=Settings&action=index'><img src='".$image_path."/settings.gif' hspace='3' align='absmiddle' border='0'>".$app_strings['LBL_SETTINGS']."</a>");
