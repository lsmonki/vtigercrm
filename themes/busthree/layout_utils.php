 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvsroot/sugarcrm/sugarcrm/themes/busthree/layout_utils.php,v 1.11 2004/08/08 23:16:13 sugarjacob Exp $
...
if ($show_help) {
    ...
    $the_title .= "<td class='bodySmall' align='right'>[ <A href='http://www.sugarcrm.com/home/component/option,com_docman' target='_blank'>".$app_strings['LNK_HELP']."</A> ]</td>\n";
}
else {
