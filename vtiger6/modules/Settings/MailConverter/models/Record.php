...
class Settings_MailConverter_Record_Model extends Settings_Vtiger_Record_Model {
	...
	public function delete() {
        vimport('~~modules/Settings/MailScanner/core/MailScannerInfo.php');
...
//        print_r($scannerLatestInfo->scannerid);die;
		...
		if(!$scannerOldInfo->compare($scannerLatestInfo)) {
            vimport('~~modules/Settings/MailScanner/core/MailBox.php');
	...
	public function scanNow() {
		...
		if ($isValid) {
			vimport('~~modules/Settings/MailScanner/core/MailScannerInfo.php');
			vimport('~~modules/Settings/MailScanner/core/MailScanner.php');
