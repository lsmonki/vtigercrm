...
class ModComments_Record_Model extends Vtiger_Record_Model {
	...
	public static function getRecentComments($parentRecordId, $pagingModel){
		...
		$queryGenerator->setFields(array('parent_comments', 'createdtime', 'related_to',
									'assigned_user_id', 'commentcontent', 'creator', 'id', 'customer'));
	...
	public static function getAllParentComments($parentId) {
		...
		$listView = Vtiger_ListView_Model::getInstance('ModComments');
		$queryGenerator = $listView->get('query_generator');
		$queryGenerator->setFields(array('parent_comments', 'createdtime', 'related_to', 'id',
											'assigned_user_id', 'commentcontent', 'creator', 'customer'));
		$query = $queryGenerator->getQuery();
	...
	public function getChildComments() {
		...
		$queryGenerator = $listView->get('query_generator');
		$queryGenerator->setFields(array('parent_comments', 'createdtime', 'related_to', 'id',
											'assigned_user_id', 'commentcontent', 'creator'));
		$query = $queryGenerator->getQuery();
