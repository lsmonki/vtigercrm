...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-bordered">
		...
		<tr data-currency-id={$price.curname}>
			...
			<td>
				<span class="row-fluid">
					<span class="span alignBottom">{$price.currencylabel|@getTranslatedCurrencyString} ({$price.currencysymbol})</span>
	...
	<div class="modal-footer quickCreateActions">
		...
		<button class="btn btn-success" id="saveCurrencies" type="button"><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>
	</div>
</div>
{/strip}