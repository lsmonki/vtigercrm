...
if($user_emailid != '')
{
	$mail_status = send_mail('Campaign',$user_emailid,$HELPDESK_SUPPORT_NAME,$HELPDESK_SUPPORT_EMAIL_ID,$subject,$email_body);
...
if($emailoptout == 0)
{
	...
	if($_REQUEST['parent_id'] != '' && $_REQUEST['parent_type'] != '')
		...
		$mail_status = send_mail('Campaign',$parent_email,$HELPDESK_SUPPORT_NAME,$HELPDESK_SUPPORT_EMAIL_ID,$subject,$email_body);
