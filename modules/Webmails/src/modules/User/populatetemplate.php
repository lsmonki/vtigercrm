...
$sql = "select templatename,body,subject from emailtemplates where templateid='".$_REQUEST["templateid"] ."'";
...
//store the subject in a seperate file
$fileContentSubject = $tempArray["subject"];
	$vtlog->logthis("the filecontentSubject is ".$fileContentSubject,'debug');  
$handle = fopen($root_directory.'/modules/Emails/templates/'.$_REQUEST["templatename"]."subject","wb") ;
fwrite($handle,$fileContentSubject,89999999);
fclose($handle);
