...
echo get_module_title("Vendors", "Vendors" , true);
echo "<br>";
//echo get_form_header("Product Search", "", false);

$xtpl=new XTemplate ('modules/Vendors/Popup.html');
...
if (!isset($_REQUEST['search_form']) || $_REQUEST['search_form'] != 'false') {
	...
	echo get_form_header($current_module_strings['LBL_VENDOR_SEARCH_FORM_TITLE'],'', false);
        $search_form=new XTemplate ('modules/Vendors/PopupSearchForm.html');
	...
	$search_form->assign("BASIC_LINK", "index.php?module=Vendors".$ordby."&action=index".$url_string."&sorder=".$sorder);
	$search_form->assign("ADVANCE_LINK", "index.php?module=Vendors&action=index".$ordby."&advanced=true".$url_string."&sorder=".$sorder);
        ...
        if (isset($_REQUEST['advanced']) && $_REQUEST['advanced'] == 'true')
	{
		...
		$search_form->assign("ALPHABETICAL",AlphabeticalSearch('Vendors','index','vendorname','true','advanced'));
	...
	{
		$search_form->assign("ALPHABETICAL",AlphabeticalSearch('Vendors','Popup','vendorname','true','basic',$popuptype));
...
$listview_header = getSearchListViewHeader($focus,"Vendors",$url_string,$sorder,$order_by);
$xtpl->assign("LISTHEADER", $listview_header);


$listview_entries = getSearchListViewEntries($focus,"Vendors",$list_result,$navigation_array);
...
$navigationOutput = getTableHeaderNavigation($navigation_array, $url_string,"Vendors",'Popup');
