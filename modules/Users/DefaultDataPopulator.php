...
class DefaultDataPopulator extends CRMEntity {
    ...
    */
	...
	$this->db->query("insert into vtiger_blocks values (78,26,'LBL_EXPECTATIONS_AND_ACTUALS',3,0,0,0,0,0)");
	...
	//Added a New Block User Image Info in Users Module
	$this->db->query("insert into vtiger_blocks values (83,29,'LBL_USER_IMAGE_INFORMATION',4,0,0,0,0,0)");
	//New blocks for the Organization Module
	$this->db->query("insert into vtiger_blocks values (84,30,'LBL_COMPANY_DETAILS',1,0,0,0,0,0)");
	$this->db->query("insert into vtiger_blocks values (85,30,'LBL_COMPANY_TEMPLATES',2,0,0,0,0,0)");
	$this->db->query("insert into vtiger_blocks values (86,30,'LBL_COMPANY_ORGUNITS',3,0,0,0,0,0)");
	$this->db->query("insert into vtiger_blocks values (87,30,'LBL_COMPANY_BANKACCOUNTS',4,0,0,0,0,0)");
	//New blocks for the Organization Unit Module
	$this->db->query("insert into vtiger_blocks values (88,31,'LBL_ORGUNIT_DETAILS',2,0,0,0,0,0)");
	$this->db->query("insert into vtiger_blocks values (89,31,'LBL_ORGUNIT_TEMPLATES',3,0,0,0,0,0)");
	$this->db->query("insert into vtiger_blocks values (90,31,'LBL_COMPANY_DETAILS',1,0,0,0,0,0)");
	//New blocks for the Company and OrgUnit assignment in various modules
	$this->db->query("insert into vtiger_blocks values (91,14,'LBL_COMPANY_ASSIGNMENT',7,0,0,0,0,0)"); // Products
	$this->db->query("insert into vtiger_blocks values (92,6,'LBL_COMPANY_ASSIGNMENT',5,0,0,0,0,0)"); // Accounts
	$this->db->query("insert into vtiger_blocks values (93,4,'LBL_COMPANY_ASSIGNMENT',7,0,0,0,0,0)"); // Contacts
	$this->db->query("insert into vtiger_blocks values (94,18,'LBL_COMPANY_ASSIGNMENT',5,0,0,0,0,0)"); // Vendors
	$this->db->query("insert into vtiger_blocks values (95,19,'LBL_COMPANY_ASSIGNMENT',4,0,0,0,0,0)"); // Pricebooks
	$this->db->query("insert into vtiger_blocks values (96,7,'LBL_COMPANY_ASSIGNMENT',5,0,0,0,0,0)"); // Leads
	$this->db->completeTransaction();
	...
	//Block 92 Company Assignment
	$this->db->query("INSERT INTO vtiger_field VALUES (6,".$this->db->getUniqueID("vtiger_field").",'otherorgs','vtiger_entity2org',1,'14','otherorgs','Organization Assignment',1,0,0,100,1,92,1,'V~O',1,null,'BAS')");
	...
	//Block 96 Company Assignment -- Start
	$this->db->query("INSERT INTO vtiger_field VALUES (7,".$this->db->getUniqueID("vtiger_field").",'otherorgs','vtiger_entity2org',1,'14','otherorgs','Organization Assignment',1,0,0,100,1,96,1,'V~O',1,null,'BAS')");
	//Block 96 Company Assignment -- End
	...
	$this->db->query("insert into vtiger_field values (4,".$this->db->getUniqueID("vtiger_field").",'otherphone','vtiger_contactsubdetails',1,'11','otherphone','Phone',1,0,0,100,9,4,1,'V~O',1,null,'ADV')");
	...
	//Block 93 Company Assignment -- Start
	$this->db->query("INSERT INTO vtiger_field VALUES (4,".$this->db->getUniqueID("vtiger_field").",'otherorgs','vtiger_entity2org',1,'14','otherorgs','Organization Assignment',1,0,0,100,1,93,1,'V~O',1,null,'BAS')");
	//Block 93 Company Assignment -- End 
	//Contact Details -- END
	...
	$this->db->query("INSERT INTO vtiger_field VALUES (2,".$this->db->getUniqueID("vtiger_field").",'orgunitid','vtiger_potential',1,'12','orgunit','Organization unit',1,0,0,100,13,1,1,'N~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (2,".$this->db->getUniqueID("vtiger_field").",'createdtime','vtiger_crmentity',1,'70','createdtime','Created Time',1,0,0,100,14,1,2,'T~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (2,".$this->db->getUniqueID("vtiger_field").",'modifiedtime','vtiger_crmentity',1,'70','modifiedtime','Modified Time',1,0,0,100,15,1,2,'T~O',1,null,'BAS')");
	...
	$this->db->query("insert into vtiger_field values(26,".$this->db->getUniqueID("vtiger_field").",'targetsize','vtiger_campaign',1,'1','targetsize','TargetSize',1,0,0,100,8,76,1,'N~O',1,null,'BAS')");
	...
	//Block 91 Company Assignment
	$this->db->query("INSERT INTO vtiger_field VALUES (14,".$this->db->getUniqueID("vtiger_field").",'otherorgs','vtiger_entity2org',1,'14','otherorgs','Organization Assignment',1,0,0,100,1,91,1,'V~O',1,null,'BAS')");
	...
	$this->db->query("insert into vtiger_field values (9,".$this->db->getUniqueID("vtiger_field").",'status','vtiger_activity',1,'111','taskstatus','Status',1,0,0,100,9,19,1,'V~O',0,3,'BAS')");
	...
	$this->db->query("insert into vtiger_field values (16,".$this->db->getUniqueID("vtiger_field").",'eventstatus','vtiger_activity',1,'111','eventstatus','Status',1,0,0,100,10,41,1,'V~O',0,3,'BAS')");
	...
	//Block 94 Company Assignment
	$this->db->query("INSERT INTO vtiger_field VALUES (18,".$this->db->getUniqueID("vtiger_field").",'otherorgs','vtiger_entity2org',1,'14','otherorgs','Organization Assignment',1,0,0,100,1,94,1,'V~O',1,null,'BAS')");
	...
	//Block 95 Company Assignment
	$this->db->query("INSERT INTO vtiger_field VALUES (19,".$this->db->getUniqueID("vtiger_field").",'otherorgs','vtiger_entity2org',1,'14','otherorgs','Organization Assignment',1,0,0,100,1,95,1,'V~O',1,null,'BAS')");
	...
	$this->db->query("insert into vtiger_field values (20,".$this->db->getUniqueID("vtiger_field").",'adjustment','vtiger_quotes',1,'1','txtAdjustment','Adjustment',1,0,0,100,21,51,3,'NN~O',1,null,'BAS')");
	...
	$this->db->query("INSERT INTO vtiger_field VALUES (20,".$this->db->getUniqueID("vtiger_field").",'orgunitid','vtiger_quotes',1,'12','orgunit','Organization unit',1,0,0,100,18,51,1,'N~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (20,".$this->db->getUniqueID("vtiger_field").",'createdtime','vtiger_crmentity',1,'70','createdtime','Created Time',1,0,0,100,19,51,2,'T~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (20,".$this->db->getUniqueID("vtiger_field").",'modifiedtime','vtiger_crmentity',1,'70','modifiedtime','Modified Time',1,0,0,100,20,51,2,'T~O',1,null,'BAS')");
	...
	$this->db->query("INSERT INTO vtiger_field VALUES (21,".$this->db->getUniqueID("vtiger_field").",'orgunitid','vtiger_purchaseorder',1,'12','orgunit','Organization unit',1,0,0,100,17,57,1,'N~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (21,".$this->db->getUniqueID("vtiger_field").",'createdtime','vtiger_crmentity',1,'70','createdtime','Created Time',1,0,0,100,18,57,2,'T~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (21,".$this->db->getUniqueID("vtiger_field").",'modifiedtime','vtiger_crmentity',1,'70','modifiedtime','Modified Time',1,0,0,100,19,57,2,'T~O',1,null,'BAS')");
	...
	$this->db->query("INSERT INTO vtiger_field VALUES (22,".$this->db->getUniqueID("vtiger_field").",'orgunitid','vtiger_salesorder',1,'12','orgunit','Organization unit',1,0,0,100,18,63,1,'N~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (22,".$this->db->getUniqueID("vtiger_field").",'createdtime','vtiger_crmentity',1,'70','createdtime','Created Time',1,0,0,100,19,63,2,'T~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (22,".$this->db->getUniqueID("vtiger_field").",'modifiedtime','vtiger_crmentity',1,'70','modifiedtime','Modified Time',1,0,0,100,20,63,2,'T~O',1,null,'BAS')");
	...
	$this->db->query("INSERT INTO vtiger_field VALUES (23,".$this->db->getUniqueID("vtiger_field").",'orgunitid','vtiger_invoice',1,'12','orgunit','Organization unit',1,0,0,100,17,69,1,'N~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (23,".$this->db->getUniqueID("vtiger_field").",'createdtime','vtiger_crmentity',1,'70','createdtime','Created Time',1,0,0,100,18,69,2,'T~O',1,null,'BAS')");
	$this->db->query("insert into vtiger_field values (23,".$this->db->getUniqueID("vtiger_field").",'modifiedtime','vtiger_crmentity',1,'70','modifiedtime','Modified Time',1,0,0,100,19,69,2,'T~O',1,null,'BAS')"); 
	...
	//Organization Details Starts Block 84,85,86,87
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'organizationname','vtiger_organizationdetails',1,'2','organizationname','Company Name',1,0,0,60,3,84,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'logo','vtiger_organizationdetails',1,'107','logo','Company Logo',1,0,0,100,1,84,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'address','vtiger_organizationdetails',1,'2','address','Address',1,0,0,150,2,84,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'state','vtiger_organizationdetails',1,'1','state','State',1,0,0,100,10,84,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'code','vtiger_organizationdetails',1,'2','code','Postal Code',1,0,0,30,4,84,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'country','vtiger_organizationdetails',1,'2','country','Country',1,0,0,100,8,84,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'phone','vtiger_organizationdetails',1,'2','phone','Phone',1,0,0,30,7,84,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'fax','vtiger_organizationdetails',1,'2','fax','Fax',1,0,0,30,9,84,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'website','vtiger_organizationdetails',1,'17','website','Website',1,0,0,100,5,84,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'city','vtiger_organizationdetails',1,'2','city','City',1,0,0,100,6,84,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'quote_template','vtiger_organizationdetails',1,'1','quote_template','Quote Template',1,0,0,30,1,85,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'po_template','vtiger_organizationdetails',1,'1','po_template','Purchase Order Template',1,0,0,30,2,85,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'so_template','vtiger_organizationdetails',1,'1','so_template','Sales Order Template',1,0,0,30,3,85,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (30,".$this->db->getUniqueID("vtiger_field").",'invoice_template','vtiger_organizationdetails',1,'1','invoice_template','Invoice Template',1,0,0,30,4,85,1,'V~O',1,null,'BAS')");

	//Organization Units Starts Block 88,89,90
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'name','vtiger_orgunit',1,'32','name','OrgUnit Name',1,0,0,60,3,88,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'type','vtiger_orgunit',1,'16','orgunittype','OrgUnit Type',1,0,0,100,1,88,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'address','vtiger_orgunit',1,'4','address','Address',1,0,0,150,2,88,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'state','vtiger_orgunit',1,'3','state','State',1,0,0,100,10,88,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'code','vtiger_orgunit',1,'4','code','Postal Code',1,0,0,30,4,88,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'country','vtiger_orgunit',1,'4','country','Country',1,0,0,100,8,88,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'phone','vtiger_orgunit',1,'4','phone','Phone',1,0,0,30,7,88,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'fax','vtiger_orgunit',1,'4','fax','Fax',1,0,0,30,9,88,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'website','vtiger_orgunit',1,'18','website','Website',1,0,0,100,5,88,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'city','vtiger_orgunit',1,'4','city','City',1,0,0,100,6,88,1,'V~M',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'quote_template','vtiger_orgunit',1,'3','quote_template','Quote Template',1,0,0,30,1,89,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'po_template','vtiger_orgunit',1,'3','po_template','Purchase Order Template',1,0,0,30,2,89,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'so_template','vtiger_orgunit',1,'3','so_template','Sales Order Template',1,0,0,30,3,89,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'invoice_template','vtiger_orgunit',1,'3','invoice_template','Invoice Template',1,0,0,30,4,89,1,'V~O',1,null,'BAS')");
	$this->db->query("INSERT INTO vtiger_field VALUES (31,".$this->db->getUniqueID("vtiger_field").",'organizationname','vtiger_orgunit',1,'8','organizationname','Organization',1,0,0,30,1,90,1,'V~M',1,null,'BAS')");
...
Should any need arise,please do give us a call.';
	...
	//Fill the vtiger_orgunittype table
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (1,'--None--',0,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (2,'Headquarter',1,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (3,'Sales Office',2,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (4,'Sales Department',3,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (5,'Marketing Department',4,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (6,'Technical Assitency Center',5,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (7,'Customer Service Center',6,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (8,'Operation Center',7,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (9,'Maintenance Center',8,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (10,'Human Resources Department',9,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (11,'Purchasing Department',10,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (12,'Development Department',11,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (13,'Provisioning Department',12,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (14,'Controlling Department',13,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (15,'Asset Management Department',14,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (16,'Bookkeeping Department',15,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (17,'Bookkeeping Office',16,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (18,'Tax Consultants',17,1)");
	$this->db->query("insert into vtiger_orgunittype(orgunittypeid,orgunittype,sortorderid,presence) values (19,'Law Enforcement Consultants',18,1)");
