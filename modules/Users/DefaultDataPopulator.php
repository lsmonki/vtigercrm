...
$this->db->query("insert into vtiger_field values (14,".$this->db->getUniqueID("vtiger_field").",'productname','vtiger_products',1,'2','productname','Product Name',1,0,0,100,1,31,1,'V~M',0,null,'BAS')");
 ...
 $this->db->query("insert into vtiger_field values (14,".$this->db->getUniqueID("vtiger_field").",'parentid','vtiger_products',1,'51','product_id','Member Of',1,0,0,100,21,31,1,'I~O',1,null,'BAS')");
...
//Block41-43-- Start
 ...
 $this->db->query("insert into vtiger_field values (16,".$this->db->getUniqueID("vtiger_field").",'activitytype','vtiger_activity',1,'111','activitytype','Activity Type',1,0,0,100,12,41,1,'V~M',0,4,'BAS')");
...
$this->db->query("insert into vtiger_field values(29,".$this->db->getUniqueID("vtiger_field").",'accesskey','vtiger_users',1,3,'accesskey','Webservice Access Key',1,0,0,100,2,84,2,'V~O',1,null,'BAS');");
...
$body='<table width="700" cellspacing="0" cellpadding="0" border="0" align="center" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; font-weight: normal; text-decoration: none; background-color: rgb(122, 122, 254);">
	...
	function addReferenceTypeInformation(){
		$referenceMapping = array("50"=>array("Accounts"),"51"=>array("Accounts"),"57"=>array("Contacts"),"58"=>array("Campaigns"),
			...
			"80"=>array("SalesOrder"),"81"=>array("Vendors"),"101"=>array("Users"),"53"=>array("Users"),"52"=>array("Users"),
