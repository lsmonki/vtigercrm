...
//Block1 -- Start
 ...
 $this->db->query("insert into field values (9,".$this->db->getUniqueID("field").",'due_date','activity',1,'5','due_date','Due Date',1,0,0,100,5,1,1,'D~M~OTH~GE~date_start~Start Date & Time')");
...
//Block1 -- Start
 ...
 $this->db->query("insert into field values (16,".$this->db->getUniqueID("field").",'due_date','activity',1,'5','due_date','End Date',1,0,0,100,5,1,1,'D~M~OTH~GE~date_start~Start Date & Time')");
...
title';
	       ...
	       $this->db->query("insert into organizationdetails(organizationame,address,city,state,country,code,phone,fax,website,logoname) values ('vtiger',' 40-41-42, Sivasundar Apartments, Flat D-II, Shastri Street, Velachery','Chennai','Tamil Nadu','India','600 042','+91-44-5202-1990','+91-44-5202-1990','www.vtiger.com','vtiger_logo.gif')");
