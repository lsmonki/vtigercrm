...
$listview_entries = getListViewEntries($focus,"Orders",$list_result,$navigation_array);
...
$navigationOutput = getTableHeaderNavigation($navigation_array, $url_string,"Orders");
