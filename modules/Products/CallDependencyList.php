...
if($singlepane_view == 'true' && $_REQUEST['action'] == 'CallDependencyList' ) {
    ...
    $dependend_array=getDependendLists($currentModule,$focus);
    $smarty->assign("DEPENDENDLISTS", $dependend_array);
