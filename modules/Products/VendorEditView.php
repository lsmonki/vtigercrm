...
$block_1 = getBlockInformation("Vendor",1,$focus->mode,$focus->column_fields);

//get Address Information

$block_2 = getBlockInformation("Vendor",2,$focus->mode,$focus->column_fields);

//get Custom Field Information
$block_3 = getBlockInformation("Vendor",3,$focus->mode,$focus->column_fields);


//get Custom Field Information
$block_5 = getBlockInformation("Vendor",5,$focus->mode,$focus->column_fields);
if(trim($block_5) != '')
{
...
$xtpl=new XTemplate ('modules/Products/VendorEditView.html');
