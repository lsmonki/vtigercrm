...
if($focus->mode != 'edit') {
        ...
        if($focus->checkModuleSeqNumber('vtiger_quotes', 'quote_no', $invstr.$invno))
				echo '<br><font color="#FF0000"><b>Duplicate Quote Number - Click <a href="index.php?module=Settings&action=CustomModEntityNo&parenttab=Settings">here</a> to Configure the Quote Number</b></font>'.$num_rows;
        else
