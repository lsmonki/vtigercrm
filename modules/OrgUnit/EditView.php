...
$log->debug("Inside OrgUnit/DetailView");

$focus = new OrgUnit();
$smarty = new vtigerCRM_Smarty();

// Edit an existing orgunit
...
elseif( isset($_REQUEST['parentid']) && $_REQUEST['parentid'] != '') {
    $focus->id = "";
    $focus->mode = "";
    $focus->column_fields["organizationname"] = $_REQUEST['parentid'];
}
...
$smarty->assign("SINGLE_MOD",$app_strings['OrgUnit']);
