 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/vtiger_crm/sugarcrm/modules/Calls/Forms.php,v 1.4 2004/10/29 09:55:09 jack Exp $
...
$lbl_duration = $mod_strings['LBL_LIST_DURATION'];
...
function verify_data(form) {
	...
	if (trim(form.duration_hours.value) == "") {
		isError = true;
		errorMessage += "\\n$lbl_duration";
	}
...
$the_form .= <<<EOQ
		...
		<form name="CallSave" onSubmit="return verify_data(CallSave) "method="POST" action="index.php">
			...
			<input type="hidden" name="duration_minutes" value="00">
		...
		<input name='date_start' id='jscal_field' maxlength='10' type="text" value="${default_date_start}"> <img src="themes/$theme/images/calendar.gif" id="jscal_trigger"><br>
