 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header:  vtiger_crm/sugarcrm/modules/Calls/Forms.php,v 1.2 2004/08/18 14:10:52 gjayakrishnan Exp $
...
function verify_data(form) {
	...
	if (isDate(form.date_start.value)==false) {
		isError = true;
		errorMessage += "\\n$lbl_date"; 
	}
...
$the_form .= <<<EOQ
		...
		<input name='date_start' type="text" maxlength='10' value="${default_date_start}"><br>
