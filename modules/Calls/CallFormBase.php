 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvsroot/vtigercrm/vtiger_crm/modules/Calls/CallFormBase.php,v 1.10 2005/01/17 05:11:29 saraj Exp $
...
$default_time_start = date('H:i');
	...
	<FONT class="required">$lbl_required_symbol</FONT>$lbl_subject<br>
		...
		<input name='${prefix}date_start' id='jscal_field' maxlength='10' type="text" value="${default_date_start}"> <img src="themes/$theme/images/calendar.gif" id="jscal_trigger"><br>
...
$the_form .= <<<EOQ
		<form name="${prefix}CallSave" onSubmit="return verify_data(${prefix}CallSave) "method="POST" action="index.php">
			<input type="hidden" name="${prefix}module" value="Calls">
			<input type="hidden" name="${prefix}action" value="Save">
		
EOQ;
$the_form .= $this->getFormBody($prefix);
$the_form .= '	<input title="$lbl_save_button_title" accessKey="$lbl_save_button_key" class="button" type="submit" name="button" value="  $lbl_save_button_label  " ></form>';
