...
function renderRelatedPotentials($query,$id)
{
  ...
  $list .= '<input type="hidden" name="return_module" value="Accounts">';
  ...
  $list .= '<td>&nbsp;</td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td valign="bottom" align="right"><input title="New Potential" accessyKey="F" class="button" onclick="this.form.action.value=\'EditView\';this.form.module.value=\'Potentials\'" type="submit" name="button" value="'.$mod_strings['LBL_NEW_POTENTIAL'].'">&nbsp;</td>';
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    $list .= '<a href="index.php?module=Potentials&action=EditView&return_module=Accounts&return_action=DetailView&record='.$row["potentialid"].'&return_id='.$row["accountid"].'">'.$app_strings['LNK_EDIT'].'</a>';
    //$list = '  |  <a href="index.php?module=Potentials&action=Delete&return_module=Accounts&return_action=DetailView&record='.$row["potentialid"].'&return_id='.$row["accountid"].'">'.$app_strings['LNK_DELETE'].'</a>';

    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="30%"><a href="index.php?module=Potentials&action=DetailView&return_module=Accounts&return_action=DetailView&record='.$row["potentialid"] .'&return_id='.$row["accountid"].'">'.$row['potentialname'].'</td>';
...
function renderRelatedEmails($query,$id)
{
  ...
  $list .= '<td>&nbsp;</td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td valign="bottom" align="right"><input title="New Email" accessyKey="F" class="button" onclick="this.form.action.value=\'EditView\';this.form.return_action.value=\'DetailView\';this.form.module.value=\'Emails\';this.form.return_module.value=\'Accounts\'" type="submit" name="button" value="'.$mod_strings['LBL_NEW_EMAIL'].'">&nbsp;</td>';
...
//  $list .= '<td class="moduleListTitle">';
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="10%" height="21" style="padding:0px 3px 0px 3px;">';
    $list .= '<a href="index.php?module=Emails&action=EditView&return_module=Accounts&return_action=DetailView&record='.$row["emailid"].'&return_id='.$_REQUEST["record"].'">'.$app_strings['LNK_EDIT'].'</a>  |  <a href="index.php?module=Emails&action=Delete&return_module=Accounts&return_action=DetailView&record='.$row["emailid"].'&return_id='.$_REQUEST["record"].'">'.$app_strings['LNK_DELETE'].'</a>';

    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="30%"><a href="index.php?module=Emails&action=DetailView&return_module=Accounts&return_action=DetailView&record='.$row["emailid"] .'&return_id='.$_REQUEST["record"].'">'.$row['subject'].'</td>';
...
function renderRelatedContacts($query,$id)
{
  ...
  $list .= '<td>&nbsp;</td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td valign="bottom" align="right"><input title="New Contact" accessyKey="F" class="button" onclick="this.form.action.value=\'EditView\';this.form.module.value=\'Contacts\'" type="submit" name="button" value="'.$mod_strings['LBL_NEW_CONTACT'].'">&nbsp;</td>';
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="10%" height="21" style="padding:0px 3px 0px 3px;">';
    $list .= '<a href="index.php?module=Contacts&action=EditView&return_module=Accounts&return_action=DetailView&record='.$row["contactid"].'&return_id='.$_REQUEST["record"].'">'.$app_strings['LNK_EDIT'].'</a>';
    //$list = '  |  <a href="index.php?module=Contacts&action=Delete&record='.$row["contactid"].'&return_module=Accounts&return_action=DetailView&return_id='.$_REQUEST["record"].'">'.$app_strings['LNK_DELETE'].'</a>';

    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="30%"><a href="index.php?module=Contacts&action=DetailView&return_module=Accounts&return_action=DetailView&record='.$row["contactid"] .'&return_id='.$_REQUEST["record"].'">'.$row['lastname'].'</td>';
   ...
   if($mail=='')
    ...
    $list .= '<a href="mailto:'.$mail.'">'.$mail.'</a>';
    $list .= '</td>';
...
function renderRelatedMeetings($query,$id)
{
  ...
  $list .= '<br><br>';
  $list .= '<table width="50%" cellpadding="0" cellspacing="0" border="0"><tbody><tr>';
  $list .= '<form border="0" action="index.php" method="post" name="form" id="form">';
  $list .= '<input type="hidden" name="module">';
  $list .= '<input type="hidden" name="mode">';
  $list .= '<input type="hidden" name="parent_id" value="'.$id.'">';
  ...
  $list .= '<input type="hidden" name="action">';
  $list .= '<td>';
  $list .= '<table cellpadding="0" cellspacing="0" border="0"><tbody><tr><td class="formHeader" vAlign="top" align="left" height="20"> <img src="' .$image_path. '/left_arc.gif" border="0"></td><td class="formHeader" vAlign="middle" background="' . $image_path. '/header_tile.gif" align="left" noWrap width="100%" height="20">'.$mod_strings['LBL_MEETING_TITLE'].'</td><td  class="formHeader" vAlign="top" align="right" height="20"><img src="' .$image_path. '/right_arc.gif" border="0"></td> </tr></tbody></table></td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td valign="bottom"><input title="Attach File" accessyKey="F" class="button" onclick="this.form.action.value=\'EditView\';this.form.return_action.value=\'DetailView\';this.form.module.value=\'Meetings\'" type="submit" name="button" value="'.$mod_strings['LBL_NEW_MEETING'].'"></td>';
  $list .= '<td width="50%"></td>';
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    if ($i%2==0)
      ...
      $trowclass = 'oddListRow';
    $list .= '<tr class="'. $trowclass.'"><td><a href="index.php?module=Meetings&action=DetailView&return_module='.$returnmodule.'&return_action='.$returnaction.'&record='.$_REQUEST["record"] .'">'.$row['name'].'</td><td></td> <td width="34%" height="21" style="padding:0px 3px 0px 3px;"><p style="margin-left: 10; margin-right: 10">';
...
//  $list .= '<td width="50%"></td>';
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="10%" height="21" style="padding:0px 3px 0px 3px;">';   
    $list .= '<a href="index.php?module=Activities&action=EditView&return_module=Accounts&return_action=DetailView&activity_mode='.$mode.'&record='.$row["activityid"].'&return_id='.$_REQUEST['record'].'">'.$app_strings['LNK_EDIT'].'</a>  |  <a href="index.php?module=Activities&action=Delete&return_module=Accounts&return_action=DetailView&record='.$row["activityid"].'&return_id='.$_REQUEST['record'].'">'.$app_strings['LNK_DELETE'].'</a>';
    $list .= '</td> ';

    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="30%"><a href="index.php?module=Activities&action=DetailView&return_module=Accounts&return_action=DetailView&activity_mode='.$mode.'&record='.$row["activityid"] .'&return_id='.$_REQUEST['record'].'">'.$row['subject'].'</td>';
...
if($row[1] == 'Notes')
    $list .= '<a href="index.php?module='.$module.'&action='.$editaction.'&return_module=Accounts&return_action=DetailView&record='.$row["noteattachmentid"].'&filename='.$row[2].'&return_id='.$_REQUEST["record"].'">'.$app_strings['LNK_EDIT'].'</a>  |  ';
    $list .= '<a href="index.php?module='.$module.'&action='.$deleteaction.'&return_module=Accounts&return_action=DetailView&record='.$row["noteattachmentid"].'&filename='.$row[2].'&return_id='.$_REQUEST["record"].'">'.$app_strings['LNK_DELETE'].'</a>';
...
function renderRelatedActivities($query,$id)
{
  ...
  $list .= '<input type="hidden" name="action">';
  $list .= '<td>';
  $list .= '<table cellpadding="0" cellspacing="0" border="0"><tbody><tr><td class="formHeader" vAlign="top" align="left" height="20"> <img src="' .$image_path. '/left_arc.gif" border="0"></td><td class="formHeader" vAlign="middle" background="' . $image_path. '/header_tile.gif" align="left" noWrap width="100%" height="20">'.$mod_strings['LBL_CALL_TITLE'].'</td><td  class="formHeader" vAlign="top" align="right" height="20"><img src="' .$image_path. '/right_arc.gif" border="0"></td> </tr></tbody></table></td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td valign="bottom"><input title="Attach File" accessyKey="F" class="button" onclick="this.form.action.value=\'EditView\';this.form.return_action.value=\'DetailView\';this.form.module.value=\'Calls\'" type="submit" name="button" value="'.$mod_strings['LBL_NEW_CALL'].'"></td>';
  $list .= '<td width="50%"></td>';
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    if ($i%2==0)
      ...
      $trowclass = 'oddListRow';
    $list .= '<tr class="'. $trowclass.'"><td><a href="index.php?module=Potentials&action=DetailView&return_module='.$returnmodule.'&return_action='.$returnaction.'&record='.$_REQUEST["record"] .'">'.$row['potentialname'].'</td><td></td> <td width="34%" height="21" style="padding:0px 3px 0px 3px;"><p style="margin-left: 10; margin-right: 10">';
    
    $list .= $row['accountname']; 
...
function renderRelatedTickets($query)
{
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="10%" height="21" style="padding:0px 3px 0px 3px;">';
    $list .= '<a href="index.php?module=HelpDesk&action=EditView&return_module=Accounts&return_action=DetailView&record='.$row["ticketid"].'&return_id='.$_REQUEST['record'].'">'.$app_strings['LNK_EDIT'].'</a>  |  <a href="index.php?module=HelpDesk&action=Delete&record='.$row["ticketid"].'&return_module=Accounts&return_action=DetailView&return_id='.$_REQUEST['record'].'">'.$app_strings['LNK_DELETE'].'</a>';
    ...
    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="25%"><a href="index.php?module=HelpDesk&action=DetailView&return_module=Accounts&return_action='.$returnaction.'&record='.$row["ticketid"] .'">'.$row['title'].'</td>';
