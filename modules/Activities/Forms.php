 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/vtiger_crm/sugarcrm/modules/Activities/Forms.php,v 1.5 2005/03/04 07:26:15 jack Exp $
...
$the_form .= <<<EOQ
		...
		<input name='duedate' maxlength="10" id='jscal_field' type="text" value=""> <img src="themes/$theme/images/calendar.gif" id="jscal_trigger"><br>
		${mod_strings['LBL_NEW_FORM_DUE_TIME']}&nbsp;<font size="1"><em>${mod_strings['LBL_NEW_TIME_FORMAT']}</em></font><br>
		<input name='duetime' maxlength='5' type="text"><br><br>
