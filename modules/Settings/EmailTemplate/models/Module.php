 ...
 */
class Settings_EmailTemplate_Module_Model extends Settings_Vtiger_Module_Model {
	...
	function getListViewUrl() {
		return 'module=EmailTemplate&parent=Settings&view=List';
	}

	/**
	 * Function returns all the Email Template Models
	 * @return <Array of EmailTemplate_Record_Model>
	 */
	function getAll() {
		...
		for($i=0; $i<$db->num_rows($result); $i++) {
			$emailTemplateModel = Settings_EmailTemplate_Record_Model::getInstance();
