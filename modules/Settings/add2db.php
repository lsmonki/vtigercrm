...
if($saveflag=="true") {
    ...
    if($org_name=='') {
        ...
        if (isset($organization_name)) {
            ...
            $sql = "UPDATE vtiger_organizationdetails SET logoname = ? WHERE organizationname = ?";
            $params = array(decode_html($organization_logoname), $org_name);
			copy($uploaddir.$organization_logoname, $uploaddir.'application.ico');
        }
    }
