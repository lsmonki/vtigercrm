...
class Asterisk {
	...
	function transfer($from,$to){
		...
		$typeCalled = substr($to, 0, strpos($to,":"));
		$to = substr($to, strpos($to, ":")+1, strlen($to));
		
		switch($typeCalled){
			case "SIP": $context = "local-extensions";
						break;
			case "PSTN": $context = "from-inside";//"outbound-dialing";
						break;
