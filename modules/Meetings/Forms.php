 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/vtiger_crm/sugarcrm/modules/Meetings/Forms.php,v 1.4 2004/10/29 09:55:09 jack Exp $
...
$lbl_duration = $mod_strings['LBL_DURATION'];
...
$the_form .= <<<EOQ
		...
		<form name="MeetingSave" onSubmit="return verify_data(MeetingSave)" method="POST" action="index.php">
