...
if($focus->mode != 'edit') {
        ...
        if($focus->checkModuleSeqNumber('vtiger_invoice', 'invoice_no', $invstr.$invno))
                echo '<br><font color="#FF0000"><b>Duplicate Invoice Number - Click <a href="index.php?module=Settings&action=CustomModEntityNo&parenttab=Settings">here</a> to Configure the Invoice Number</b></font>'.$num_rows;
        else
