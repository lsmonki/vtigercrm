...
function getTopInvoice($maxval,$calCnt)
{
	...
	$search_qry = "&query=true&Fields0=invoicestatus&Condition0=n&Srch_value0=Paid&Fields1=assigned_user_id&Condition1=e&Srch_value1=".$current_user->column_fields['user_name']."&searchtype=advance&search_cnt=2&matchtype=all";
