...
if(isset($_REQUEST['idlist']) && $_REQUEST['idlist'] != '')
{
	...
	header("Location: index.php?action=$action&module=Invoice&record=".$_REQUEST["parentid"]."&parenttab=".$parenttab);
}
...
elseif(isset($_REQUEST['entityid']) && $_REQUEST['entityid'] != '')
{
	...
	header("Location: index.php?action=$action&module=Invoice&record=".$_REQUEST["parid"]);
}
