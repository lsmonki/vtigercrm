...
{
    $focus->retrieve_entity_info($_REQUEST['record'],"Organization");
...
if(isPermitted("Organization","EditView",$_REQUEST['record']) == 'yes')
	$smarty->assign("EDIT_DUPLICATE","permitted");

if(isPermitted("Organization","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ORGUNITTAB", getOrgUnits( $focus));

$tabid = getTabid("Organization");
...
$smarty->assign("ORGVIEW", "DetailView");
