...
$xtpl=new XTemplate ('modules/PurchaseOrder/DetailView.html');
...
$block_1 = getDetailBlockInformation("PurchaseOrder",1,$focus->column_fields);
$xtpl->assign("BLOCK1_HEADER", $block_1_header);
$xtpl->assign("BLOCK1", $block_1);

//get Address Information
$block_2_header = getBlockTableHeader("LBL_ADDRESS_INFORMATION");
$block_2 = getDetailBlockInformation("PurchaseOrder",2,$focus->column_fields);
$xtpl->assign("BLOCK2_HEADER", $block_2_header);
$xtpl->assign("BLOCK2", $block_2);

//get Description Information
$block_3_header = getBlockTableHeader("LBL_DESCRIPTION_INFORMATION");
$block_3 = getDetailBlockInformation("PurchaseOrder",3,$focus->column_fields);
$xtpl->assign("BLOCK3_HEADER", $block_3_header);
$xtpl->assign("BLOCK3", $block_3);

$block_6_header = getBlockTableHeader("LBL_TERMS_INFORMATION");
$block_6 = getDetailBlockInformation("PurchaseOrder",6,$focus->column_fields);
$xtpl->assign("BLOCK6_HEADER", $block_6_header);
$xtpl->assign("BLOCK6", $block_6);

$block_4 = getDetailAssociatedProducts('PurchaseOrder',$focus);
$xtpl->assign("BLOCK4", $block_4);

$block_5 = getDetailBlockInformation("PurchaseOrder",5,$focus->column_fields);
if(trim($block_5) != '')
{
