...
if($focus->mode != 'edit') {
        ...
        if($focus->checkModuleSeqNumber('vtiger_purchaseorder', 'purchaseorder_no', $invstr.$invno))
                echo '<br><font color="#FF0000"><b>Duplicate PurchaseOrder Number - Click <a href="index.php?module=Settings&action=CustomModEntityNo&parenttab=Settings">here</a> to Configure the PurchaseOrder Number</b></font>'.$num_rows;
        else
