...
if( is_array( $orgunittab[$orgunitid])) {
    ...
    $template = $orgdetails["po_template"];
} else {
...
$pdf->Output('PurchaseOrder-'.$crmid.'.pdf','D'); //added file name to make it work in IE, also forces the download giving the user the option to save
exit();
?>
