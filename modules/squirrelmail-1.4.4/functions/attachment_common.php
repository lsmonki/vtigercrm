...
function attachment_common_link_text(&$Args) {
    ...
    $Args[1]['attachment_common']['href'] = 'index.php?module=squirrelmail-1.4.4&action=view_text&'. $QUERY_STRING;
...
function attachment_common_link_message(&$Args) {
    $Args[1]['attachment_common']['href'] = 'index.php?module=squirrelmail-1.4.4&action=read_body&startMessage=' .
...
function attachment_common_link_image(&$Args) {
    ...
    $Args[1]['attachment_common']['href'] = 'index.php?module=squirrelmail-1.4.4&action=image&'. $QUERY_STRING;
    $Args[1]['attachment_common']['href'] =
          set_url_var($Args[1]['attachment_common']['href'],
          'ent_id',$Args[5]);
...
function attachment_common_link_vcard(&$Args) {
    ...
    $Args[1]['attachment_common']['href'] = 'index.php?module=squirrelmail-1.4.4&action=vcard&'. $QUERY_STRING;
    $Args[1]['attachment_common']['href'] =
          set_url_var($Args[1]['attachment_common']['href'],
          'ent_id',$Args[5]);
