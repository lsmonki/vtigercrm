 ...
 */
// echo '<br> in display messages '.SM_PATH;
...
function error_message($message, $mailbox, $sort, $startMessage, $color) {
    ...
    $string = '<tr><td align="center">' . $message . '</td></tr>'.
              '<tr><td align="center">'.
              '<a href="'.sqm_baseuri()."index.php?module=squirrelmail-1.4.4&action=right_main&amp;sort=$sort&amp;startMessage=$startMessage&amp;mailbox=$urlMailbox\">".
