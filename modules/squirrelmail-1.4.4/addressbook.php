...
$showaddrlist = true;
$defselected  = array();
$form_url = 'index.php?module=squirrelmail-1.4.4&action=addressbook';
...
if ($showaddrlist) {
    ...
    if (count($alist) > 0) {
        ...
        while(list($undef,$row) = each($alist)) {
            ...
            echo makeComposeLink('index.php?module=squirrelmail-1.4.4&action=compose&send_to='.rawurlencode($email),
