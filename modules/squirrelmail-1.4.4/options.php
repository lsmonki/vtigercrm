...
if ($optpage == SMOPT_PAGE_MAIN) {
    ...
    if ($optmode == SMOPT_MODE_SUBMIT) {
        ...
        if ( !isset( $max_refresh ) ) {
            ...
            //echo '<a href="index.php?module=squirrelmail-1.4.4&action=left_main" target="left">' . _("Refresh Folder List") . '</a><br />';
        } else if ($max_refresh) {
            echo '<a href="index.php?module=squirrelmail-1.4.4&action=webmail&right_frame=options.php" target="' . $frame_top . '">' . _("Refresh Page") . '</a><br />';
        }
    }
    /******************************************/
    ...
    $optpage_blocks[] = array(
        ...
        'url'  => 'index.php?module=squirrelmail-1.4.4&action=options&optpage=' . SMOPT_PAGE_PERSONAL,
    ...
    */
    ...
    $optpage_blocks[] = array(
        ...
        'url'  => 'index.php?module=squirrelmail-1.4.4&action=options&optpage=' . SMOPT_PAGE_DISPLAY,
...
*/
    ...
    */
    ...
    $optpage_blocks[] = array(
        'name' => _("Index Order"),
        'url'  => 'index.php?module=squirrelmail-1.4.4&action=options_order',
...
/*************************************************************************/
    ...
    echo addForm('index.php?module=squirrelmail-1.4.4&action=options', 'POST', 'f')
