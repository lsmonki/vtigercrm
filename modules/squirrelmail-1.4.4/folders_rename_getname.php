...
if ($old == '') {
    ...
    plain_error_message(_("You have not selected a folder to rename. Please do so.").
        '<br /><a href="index.php?module=squirrelmail-1.4.4&action=folders">'._("Click here to go back").'</a>.', $color);
    exit;
}
...
echo '<br />' .
    html_tag( 'table', '', 'center', '', 'width="95%" border="0"' ) .
        ...
        html_tag( 'tr' ) .
            ...
            addForm('index.php?module=squirrelmail-1.4.4&action=folders_rename_do').
     _("New name:").
