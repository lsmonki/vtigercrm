...
function renderRelatedPotentials($query,$id)
{
  ...
  $list .= '<input type="hidden" name="return_module" value="Contacts">';
  $list .= '<input type="hidden" name="return_action" value="DetailView">';
  $list .= '<input type="hidden" name="return_id" value="'.$id.'">';
  $list .= '<input type="hidden" name="account_id" value="'.$accountid.'">';
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    $list .= '<a href="index.php?module=Potentials&action=EditView&return_module=Contacts&return_action=DetailView&record='.$row["potentialid"].'&return_id='.$id.'">'.$app_strings['LNK_EDIT'].'</a>';
    //$list = '  |  <a href="index.php?module=Activities&action=Delete&return_module=Contacts&return_action=DetailView&record='.$row["potentialid"].'&return_id='.$id.'">'.$app_strings['LNK_DELETE'].'</a>';

    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="30%"><a href="index.php?module=Potentials&action=DetailView&return_module=Contacts&return_action=DetailView&record='.$row["potentialid"] .'&return_id='.$id.'">'.$row['potentialname'].'</td>';
...
function renderRelatedTasks($query)
{
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="10%" height="21" style="padding:0px 3px 0px 3px;">';
    $list .= '<a href="index.php?module=Activities&action=EditView&return_module=Contacts&return_action=DetailView&activity_mode='.$mode.'&record='.$row["activityid"].'&return_id='.$_REQUEST['record'].'">'.$app_strings['LNK_EDIT'].'</a>  |  <a href="index.php?module=Activities&action=Delete&return_module=Contacts&return_action=DetailView&record='.$row["activityid"].'&return_id='.$_REQUEST['record'].'">'.$app_strings['LNK_DELETE'].'</a>';
    $list .= '</td> ';

    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="30%"><a href="index.php?module=Activities&action=DetailView&return_module=Contacts&return_action=DetailView&activity_mode='.$mode.'&record='.$row["activityid"] .'&return_id='.$_REQUEST['record'].'">'.$row['subject'].'</td>';
...
function renderRelatedAttachments($query,$id)
{
 ...
 $list .= '<table cellpadding="0" cellspacing="0" border="0"><tbody><tr><td class="formHeader" vAlign="top" align="left" height="20"> <img src="' .$image_path. '/left_arc.gif" border="0"></td><td class="formHeader" vAlign="middle" background="' . $image_path. '/header_tile.gif" align="left" noWrap height="20">'.$app_strings['LBL_ATTACHMENT_AND_NOTES'].'</td><td  class="formHeader" vAlign="top" align="right" height="20"><img src="' .$image_path. '/right_arc.gif" border="0"></td> </tr></tbody></table></td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td valign="bottom" align="right"><input title="New Attachment" accessyKey="F" class="button" onclick="this.form.action.value=\'upload\';this.form.module.value=\'uploads\';this.form.return_action.value=\'DetailView\';this.form.return_module.value=\'Contacts\'" type="submit" name="button" value="'.$app_strings['LBL_NEW_ATTACHMENT'].'">';
...
if($row[1] == 'Notes')
    $list .= '<a href="index.php?module='.$module.'&action='.$editaction.'&return_module=Contacts&return_action=DetailView&record='.$row["noteattachmentid"].'&filename='.$row[2].'&return_id='.$_REQUEST["record"].'">'.$app_strings['LNK_EDIT'].'</a>  |  ';
    $list .= '<a href="index.php?module='.$module.'&action='.$deleteaction.'&return_module=Contacts&return_action=DetailView&record='.$row["noteattachmentid"].'&filename='.$row[2].'&return_id='.$_REQUEST["record"].'">'.$app_strings['LNK_DELETE'].'</a>';

    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="30%"><a href="index.php?module='.$module.'&action=DetailView&return_module=Contacts&return_action=DetailView&record='.$row["noteattachmentid"] .'&return_id='.$_REQUEST["record"] .'">'.$row[0].'</td>';
    ...
    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="15%" height="21" style="padding:0px 3px 0px 3px;">';
    $list .= '<a href = "index.php?module=uploads&action=downloadfile&return_module=Contacts&activity_type='.$row[1].'&fileid='.$row[5].'&filename='.$row[2].'">'.$row[2].'</a>'; 
    $list .= '</td>';
...
function renderRelatedEmails($query)
{
  ...
  $result=$adb->query($query);  
  $id = $_REQUEST['record']; 
  $parentid=$adb->query_result($result,0,'crmid'); 
  ...
  $list .= '<input type="hidden" name="return_action" value="DetailView">';
  $list .= '<input type="hidden" name="return_id" value="'.$id.'">';
  $list .= '<input type="hidden" name="parent_id" value="'.$parentid.'">';
  $list .= '<input type="hidden" name="action">';
  $list .= '<td>';
  ...
  $list .= '<td>&nbsp;</td>';
  $list .= '<td>&nbsp;</td>';
  $list .= '<td valign="bottom" align="right"><input title="New Email" accessyKey="F" class="button" onclick="this.form.action.value=\'EditView\';this.form.module.value=\'Emails\'" type="submit" name="button" value="'.$mod_strings['LBL_NEW_EMAIL'].'"></td>';
//  $list .= '<td width="50%"></td>';
...
//  $list .= '<td class="moduleListTitle">';
  ...
  while($row = $adb->fetch_array($result))
  {
    ...
    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="10%" height="21" style="padding:0px 3px 0px 3px;">';
    $list .= '<a href="index.php?module=Emails&action=EditView&return_module=Contacts&return_action=DetailView&record='.$row["emailid"].'&return_id='.$id.'">'.$app_strings['LNK_EDIT'].'</a>  |  <a href="index.php?module=Emails&action=Delete&return_module=Contacts&return_action=DetailView&record='.$row["emailid"].'&return_id='.$id.'">'.$app_strings['LNK_DELETE'].'</a>';

    $list .= '<td WIDTH="1" class="blackLine"><IMG SRC="themes/'.$theme.'/images/blank.gif">';
    $list .= '<td width="30%"><a href="index.php?module=Emails&action=DetailView&return_module=Contacts&return_action=DetailView&record='.$row["emailid"] .'&return_id='.$id.'">'.$row['subject'].'</td>';
