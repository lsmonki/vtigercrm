...
if($focus->mode != 'edit') {
        ...
        if($focus->checkModuleSeqNumber('vtiger_contactdetails', 'contact_no', $invstr.$invno))
                echo '<br><font color="#FF0000"><b>Duplicate Contact Number - Click <a href="index.php?module=Settings&action=CustomModEntityNo&parenttab=Settings">here</a> to Configure the Contact Number</b></font>'.$num_rows;
        else
