...
if (!isset($_REQUEST['search_form']) || $_REQUEST['search_form'] != 'false') {
	...
	$search_form->assign("BASIC_LINK", "index.php?module=SalesOrder".$ordby."&action=index".$url_string."&sorder=".$sorder);
	$search_form->assign("ADVANCE_LINK", "index.php?module=SalesOrder&action=index".$ordby."&advanced=true".$url_string."&sorder=".$sorder);
...
//Combo Fields for Manufacturer and Category are moved from advanced to Basic Search
        if (isset($_REQUEST['advanced']) && $_REQUEST['advanced'] == 'true') 
	{
		...
		$search_form->assign("ALPHABETICAL",AlphabeticalSearch('SalesOrder','Popup','subject','true','advanced',$popuptype,"","","",$viewid));
	...
	{        
		$search_form->assign("ALPHABETICAL",AlphabeticalSearch('SalesOrder','Popup','subject','true','basic',$popuptype,"","","",$viewid));
