...
if($focus->mode != 'edit') {
        ...
        if($focus->checkModuleSeqNumber('vtiger_faq', 'faq_no', $invstr.$invno))
                echo '<br><font color="#FF0000"><b>Duplicate Faq Number - Click <a href="index.php?module=Settings&action=CustomModEntityNo&parenttab=Settings">here</a> to Configure the Faq Number</b></font>'.$num_rows;
        else
