...
</em>[<a href="javascript:void(0)" onClick="changeView('<?php echo $_REQUEST['display_view'];?>');"><?php echo $current_module_strings['LBL_REFRESH'];?></a>]
[<a href="index.php?module=<?php echo $currentModule;?>&action=index&pbls_edit=true&display_view=<?php echo $_REQUEST['display_view'];?>"><?php echo $current_module_strings['LBL_EDIT'];?></a>]
</FONT></div>
<?php } 
}
else
