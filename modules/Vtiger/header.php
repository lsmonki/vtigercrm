...
$userName = getDisplayName(array('f'=>$current_user->column_fields['first_name'], 'l'=>$current_user->column_fields['last_name']), 'fl');
...
$smarty->assign("CURRENT_USER", getDisplayName($current_user->user_name));
