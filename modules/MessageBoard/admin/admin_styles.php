 ...
 *
 *   $Id: admin_styles.php,v 1.9 2005/01/04 15:04:13 saraj Exp $
 *
 *
 ***************************************************************************/
...
if( !empty($setmodules) )
{
	...
	//$forum_module['Styles']['Add_new'] = "$file?mode=addnew";
	//$forum_module['Styles']['Create_new'] = "$file?mode=create";
	//$forum_module['Styles']['Manage'] = "$file";
	//$forum_module['Styles']['Export'] = "$file?mode=export";
	return;
}
