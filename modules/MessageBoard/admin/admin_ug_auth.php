 ...
 *
 *   $Id: admin_ug_auth.php,v 1.9 2005/01/04 15:04:13 saraj Exp $
 *
 *
 ***************************************************************************/
...
if( !empty($setmodules) )
{
	...
	$forum_module['Users']['Permissions'] = $filename . "?mode=user";
	#$forum_module['Groups']['Permissions'] = $filename . "?mode=group";
