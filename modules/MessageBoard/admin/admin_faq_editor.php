<?php
/***************************************************************************
      Admin FAQ Editor 0.8.7 for phpBB 2.0.4, 2.0.5
...
if( !empty($setmodules) )
{
	...
	//$forum_module['Language_edit']['faq'] = "$file?file=faq";
	//$forum_module['Language_edit']['bbcode'] = "$file?file=bbcode";
	//$forum_module['Language_edit']['attach_faq'] = "$file?file=faq_attach";
	return;
}
