 ...
 *
 *   $Id: admin_forumauth.php,v 1.9 2005/01/04 15:04:13 saraj Exp $
 *
 *
 ***************************************************************************/
...
if( !empty($setmodules) )
{
	...
	$forum_module['Forums']['Permissions']   = $filename;
...
$forum_auth_levels = array('ALL', 'REG', 'PRIVATE', 'SELF', 'MOD', 'ADMIN');
$forum_auth_const = array(AUTH_ALL, AUTH_REG, AUTH_ACL, AUTH_SELF, AUTH_MOD, AUTH_ADMIN);
