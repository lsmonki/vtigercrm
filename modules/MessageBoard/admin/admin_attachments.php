 ...
 *
 *   $Id: admin_attachments.php,v 1.9 2005/01/04 15:04:13 saraj Exp $
 *
 ***************************************************************************/
...
//	$forum_module['Attachments']['Manage'] = $filename . '?mode=manage';
//	$forum_module['Attachments']['Shadow_attachments'] = $filename . '?mode=shadow';
//	$forum_module['Extensions']['Special_categories'] = $filename . '?mode=cats';
//	$forum_module['Attachments']['Sync_attachments'] = $filename . '?mode=sync';
//	$forum_module['Attachments']['Quota_limits'] = $filename . '?mode=quota';
	return;
}
