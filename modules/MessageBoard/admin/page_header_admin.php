 ...
 *
 *   $Id: page_header_admin.php,v 1.9 2005/01/04 15:04:14 saraj Exp $
 *
 *
 ***************************************************************************/
...
{
        $theme_crm = $_SESSION['authenticated_user_theme'];
}
else
{
        $theme_crm = $default_theme;
}
//
// gzip_compression
//
