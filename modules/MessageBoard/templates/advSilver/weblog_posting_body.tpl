...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
	  ...
	  <td class="row2" width="78%"> <span class="gen">
		...
		</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" />&nbsp;&nbsp;&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" /></td>
	</tr>
	<!-- BEGIN switch_mood_checkbox -->
	<tr>
	  <td valign="top" class="row1"><span class="gen"><b>{L_WEBLOG_MOOD}</b></td>
	  <td class="row2"><span class="gen">
		<table width="450" border="0" cellspacing="0" cellpadding="2"><tr><td>
			{MOOD_SELECT} &nbsp; <img name="mood_image" src="images/weblogs/{MOOD}" border="0" alt="" /> &nbsp;
		</td></tr></table>
	  </td>
	</tr>
	<!-- END switch_mood_checkbox -->
	<!-- BEGIN switch_currently -->
	<tr>
	  <td class="row1" width="22%"><span class="gen"><b>{L_WEBLOG_CURRENTLY}</b></span></td>
	  <td class="row2" width="78%"> <span class="gen">
		{CURRENTLY1_SELECT}&nbsp; <img name="currently_image" src="images/weblogs/{CURRENTLY_IMG}" border="0" alt="" /><br /><input type="text" name="currently2" size="45" maxlength="100" style="width:450px" tabindex="2" class="post" value="{CURRENTLY2}" />
		</span> </td>
	</tr>
	<!-- END switch_currently -->
	<!-- BEGIN switch_blogcat_checkbox -->
	<tr>
	  <td valign="top" class="row1"><span class="gen"><b>{L_WEBLOG_CATEGORIES}</b></td>
	  <td class="row2"><span class="gen">
		<table width="450" border="0" cellspacing="0" cellpadding="2"><tr><td>
			{WEBLOG_CAT_SELECT} &nbsp;
		</td></tr></table>
	...
	<tr>
	  ...
	  <td class="row2"><span class="gen"> </span>
		<table cellspacing="0" cellpadding="1" border="0">
		  ...
		  <tr>
			<td></td>
			<td><span class="gen">{S_TYPE_TOGGLE2}</span></td>
		  </tr>
