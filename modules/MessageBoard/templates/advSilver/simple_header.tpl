...
td.rowpic {
		...
		background-image: url(templates/advSilver/images/{T_TH_CLASS3});
...
th	{
	...
	background-image: url(templates/advSilver/images/{T_TH_CLASS2});
}

td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom {
			background-image: url(templates/advSilver/images/{T_TH_CLASS1});
