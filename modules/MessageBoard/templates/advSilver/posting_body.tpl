...
function popup(docUrl,nw,nh)
{
	...
	window.open(docUrl,'','width=' + popW + ',height='+popH+',top='+topPos+',left='+leftPos+',scrollbars=yes');
}
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
	  ...
	  <td class="row2" width="78%"> <span class="gen">
		<input type="text" name="subject" size="45" maxlength="60" style="width:450px" tabindex="2" class="post" value="{SUBJECT}" {S_HIDDEN_FORM_FIELDS} &nbsp; &nbsp; &nbsp;<input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" />&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}"/>
		</span></td>
	</tr>
	<tr>
          <td class="row1" width="22%"><span class="gen"><b>Copy to</b></span></td>
          <td class="row2" width="78%"> <span class="gen">
                        <input type="text" name="cc_mail" size="45" style="width:450px" tabindex="2" class="post"  value="{COPYTO}" />
                		</span></td>
    </tr>
	<tr>
	  ...
	  <td class="row2" valign="top"><span class="gen"> <span class="genmed"> </span>
		<table width="450" border="0" cellspacing="0" cellpadding="2">
		  ...
		  <tr>
			...
			<!-- BEGIN switch_post_public_checkbox -->
		   	 <td valign="top" nowrap style="width:375px"><span class="gensmall">{L_POST_PUBLIC_MESSAGE}<br><br>
			 <input type="checkbox" name="post_public" {S_POST_PUBLIC_CHECKED}/>
			 &nbsp;{L_POST_PUBLIC}<br><br>
			 <span class="gen"><select class="post" name="move_public">{S_MOVE_FORUMS}</select></span><br><br><br>
			 <!-- <span class="row2">{L_SUPPORT_MESSAGE}<br>{L_SUPPORT_MAIL}&nbsp;<input type="text" name="post_email" size="25" style="width:200px" class="post" class="row2"/ > -->
			</span></td>
		 	<!-- END switch_post_public_checkbox -->
		  </tr>
