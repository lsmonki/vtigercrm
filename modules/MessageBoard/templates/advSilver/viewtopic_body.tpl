<table width="100%" cellspacing="2" cellpadding="2" border="0">
  <tr>
	<td valign="top"></td><td align="left" valign="bottom" colspan="2"><a class="maintitle" href="{U_VIEW_TOPIC}">{TOPIC_TITLE}</a><br />
...
<!-- table width="100%" cellspacing="2" border="0" align="center">
  <tr>
	<td width="40%" valign="top" nowrap="nowrap" align="left"><span class="gensmall"><!-- BEGIN switch_user_logged_in -->
{S_WATCH_TOPIC}<br /><a href="{U_FAV}">{L_FAV}</a>
<!-- END switch_user_logged_in --></span><br />
	  &nbsp;<br />
	  {S_TOPIC_ADMIN}</td>
