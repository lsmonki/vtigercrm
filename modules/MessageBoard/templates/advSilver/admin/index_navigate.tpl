...
<table width="100%" cellpadding="4" cellspacing="0" border="0" align="center">
  <tr> 
	<td align="center" ><a href="{U_FORUM_INDEX}" target="_parent"><img src="../../../include/images/vtiger.jpg" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
	  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
		...
		<tr> 
		  <td class="row1"><span class="genmed"><a href="{U_CRM_INDEX}" target="_top" class="genmed">{L_VTIGER_CRM}</a></span></td>
		</tr>
		<!-- BEGIN catrow -->
		<tr> 
