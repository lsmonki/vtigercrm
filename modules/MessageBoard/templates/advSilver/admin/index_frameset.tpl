...
<tr>
<td width="30%">
<iframe  name="leftpane" src="{S_FRAME_NAV}" align="top" height="100%" width="95%" hspace="0" vspace="0" align="middle">
</iframe>
</td>
<td width="70%">
<iframe  name="rightpane" src="{S_FRAME_MAIN}" align="top" height="100%" width="95%" hspace="0" vspace="0" align="middle">
</iframe>
</td>
</tr>
</table-->
