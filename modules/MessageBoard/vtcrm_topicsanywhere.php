 ...
 *
 *   $Id: vtcrm_topicsanywhere.php,v 1.9 2005/01/04 15:04:12 saraj Exp $
 *
 ***************************************************************************/
...
define('TA_SCRIPT_NAME', 'vtcrm_topicsanywhere');
...
if ($HTTP_GET_VARS['mode'] == "show") // generates topics for output on any page using JavaScript document.writeln (quite heavily modified code from viewtopic.php)
{
	...
	if (!$error) // there are no critical arguments missing - start with generating SQL, then execute it
	{
		...
		if ($out == 'js') {
			...
			if ($data !== false)
			{
				$item = '<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n<tr><td class="leftFormHeader" align=\"center\">Forums Latest Topics</td></tr></table>\n';
				$item .= '<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"2\" class="formOuterBorder" align=\"center\">\n';

				for($i = 0; $i < $total_topics; $i++)
				{
					if ($bgclass == "oddListRow")
					{
						$bgclass = "evenListRow";
    				}
					else
...
*/						$item .= '</td><td class=\"'. $bgclass . '\">';
				...
				$item .= '<tr><td colspan=\"2\" align=\"right\" ><a href=\"http://www.vtiger.com/forums/index.php?c=3\" target=\"_blank\">More...&nbsp;</a></td></tr></table>';
