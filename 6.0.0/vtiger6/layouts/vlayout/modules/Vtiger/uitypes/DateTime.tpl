...
{assign var="dateFormat" value=$USER_MODEL->get('date_format')}
	<input id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}" type="text" class="input-large dateTimeField" name="{$FIELD_MODEL->get('name')}" data-date-format="{$dateFormat}"
