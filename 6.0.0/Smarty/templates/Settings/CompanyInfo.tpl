                        ...
                        <tr>
                            <td>
                                <table border=0 cellspacing=0 cellpadding=5 width=100% class="tableHeading">
                                    <tr>
                                        <td class="big"><strong>{$MOD.LBL_ORGANIZATION_LOGO}</strong></td>
                                        <td class="small" align="right">
                                            <input class="crmButton small edit" type="submit" value="Update Logo" name="Update Logo" onclick="this.form.action.value='EditCompanyDetails'" accesskey="E" title="Update Logo">
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td class="small" valign=top >
                                            <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                                                <tr valign="top">
                                                    <td class="small cellLabel" width="20%"><strong>{$MOD.LBL_ORGANIZATION_LOGO}</strong></td>
                                                    <td	class="small cellText" width="80%"><img src="{$ORGANIZATIONLOGOPATH}/{$ORGANIZATIONLOGONAME}" style="width: 15em;height: 4.2em;"/></td>
                                                </tr>
                                            </table>
                                        <td>
                                    </tr>
                                ...
                                <table width=100% class="tableHeading" border=0 cellspacing=0 >
                                    <tr>
                                        <td class="small cellLabel" style="white-space: normal;">
                                            <div id="note">
                                                {'LBL_EDIT_COMPANY_INFO'|@getTranslatedString:'Settings'}
                                            </div>
                                        </td>
                                    </tr>
                                </table>
