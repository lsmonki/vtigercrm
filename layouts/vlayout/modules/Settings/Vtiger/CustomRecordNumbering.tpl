	...
	<div class="row-fluid">
		<div class="span9">
			<span>
				...
				<tr>
					<th width="30%">
						<span>{vtranslate('LBL_CUSTOMIZE_RECORD_NUMBERING', $QUALIFIED_MODULE)}</span>
					</th>
					<th width="70%">
				...
				<tr>
					...
					<td class="fieldValue">
						<input type="text" value="{$DEFAULT_MODULE_DATA['prefix']}" name="prefix" data-validation-engine="validate[funcCall[Vtiger_AlphaNumeric_Validator_Js.invokeValidation]]"/>
					</td>
				</tr>
				<tr>
					<td class="fieldLabel">
