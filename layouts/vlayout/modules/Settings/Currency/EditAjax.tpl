...
{strip}
	...
	<div class="currencyModalContainer">
		...
		<form id="editCurrency" class="form-horizontal contentsBackground">
			<input type="hidden" name="record" value="{$CURRENCY_ID}" />
			<div class="modal-body">
				<div class="row-fluid">
					<div class="control-group">
						<label class="muted control-label"><span class="redColor">*</span>{vtranslate('LBL_CURRENCY_NAME', $QUALIFIED_MODULE)}</label>
