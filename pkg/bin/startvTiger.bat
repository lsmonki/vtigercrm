...
echo "********* You need to open the apache/conf/httpd.conf file, search for the word Listen and change the port number given******* "
echo "********* Please make the apache port number change in the startvTiger.bat file and the stopvTiger.bat file too******* "
echo ""
echo ""
echo ""
set /p pt=Press Any Key to Continue...
