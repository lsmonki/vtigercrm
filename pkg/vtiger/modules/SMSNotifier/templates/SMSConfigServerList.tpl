	...
	<tr>
        ...
        <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
			...
			<tr>
				...
				<td colspan="2" class="heading2" valign=bottom align="left"><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > {$CMOD.SERVER_CONFIGURATION} </b></td>
