				...
				<div class="listViewEntriesDiv">
					<table class="table table-bordered listViewEntriesTable">
						<thead>
							...
							&nbsp;<input type=button class='crmbutton small delete' onclick="MailManager.massMailDelete('{$FOLDER->name()}');" value="{vtranslate('LBL_Delete',$MODULE)}"/>
									&nbsp;<select style="width:auto;" id="moveFolderList" onchange="MailManager.moveMail(this);">
						...
						<div class="pull-right">
							...
							&nbsp;<img id="jscal_trigger_fval" width="20" onClick="MailManager.showCalendar();" align="absmiddle" height="20" src="" style="display:none">
							{vtranslate('LBL_IN',$MODULE)}
							&nbsp;<select style="width:auto;" id="search_type" onchange="MailManager.addRequiredElements()">
								...
								&nbsp;<input type=submit class="crmbutton small edit" onclick="MailManager.search_mails('{$FOLDER->name()}');" value="{vtranslate('LBL_FIND',$MODULE)}" id="mm_search"/>
						</div>
						</th>
						</tr>
						</thead>
