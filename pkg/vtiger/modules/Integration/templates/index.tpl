		...
		<td colspan="4">
			<div style="padding: 20px 10px">
				...
				<tr bgcolor=white valign=center>
					...
					<td class="lvtColData">
						<a href="http://wiki.vtiger.com/index.php/vtiger510:UserManual_Other_Tools_Gmail_Bookmarklet" target="_blank">{$MOD.LBL_HOW_TO_USE} {$APP.LBL_GMAIL} {$APP.LBL_BOOKMARKLET}?</a>
					</td>
				</tr>
				</table>
		</td>
