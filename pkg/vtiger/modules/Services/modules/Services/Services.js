...
function fnAddServiceRow(module,image_path){
	...
	var decimals = document.getElementById("inventory_currency_decimal_places").value;
	var listPrice = roundPriceValue(price.toString());
	var taxTotal = roundPriceValue(tax.toString());
	var discountTotal = roundPriceValue(discount.toString());
	var discountAmount = roundPriceValue(discount_amount.toString());
