...
$optionalModuleStrings = array(
		'CustomerPortal_description'=>'Management interface to control behavior of the Customer Portal plugin',
		'FieldFormulas_description'=>'Setup rules for custom fields to update value on record save',
		'RecycleBin_description'=>'Module to manage deleted records. Provides ability to restore or remove completely',
