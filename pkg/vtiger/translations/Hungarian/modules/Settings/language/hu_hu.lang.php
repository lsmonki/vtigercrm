...
'INVENTORYTERMSANDCONDITIONS'=>'Határidők és Feltételek',//newly added for Inventory terms and conditions
'LBL_INVENTORY_TERMSANDCONDITIONS'=>' - Határidők és Feltételek Szerkesztés',//newly added
...
'LBL_OPTIONS1'=>'Küldd a leveleket a saját e-mail szerveredről<br>
				- SMTP fiók adatoknak (Szerver neve, felhasználónév, Jelszó) azokat a beállításokat használd, amelyek egyeznek a Feladó email címéhez megadott beállításokkal.',
'LBL_OPTIONS2'=>"Add hozzá az od1.vtiger.com szervert mint engedélyezett küldőt a domain nevedhez.<br>
				- Ha a vtiger szervert részesítenéd előnyben, mint küldő SMTP szervert, akkor javasoljuk, hogy a domain SPF rekordjában (ennek hiányában egy SPF adatokat tartalmazó TXT rekordban) add meg a vtiger szervert, mint engedélyezett küldő szervert a domainodhoz.
				  Ha az SPF rekord beállításához segítségre lenne szükséged, akkor írj egy e-mailt az od-support@vtiger.com címre.",
...
// END
'LBL_USER_ADDITION_INFO'=>"Új felhasználó hozzáadásához kattints a  
