...
$languageStrings = array(
	...
	'LBL_ALMOST_THERE' => 'تقريبا هناك!',
	'LBL_ABOUT_ME' => 'معلومات عني',
	'LBL_WE_PROMISE_TO_KEEP_THIS_PRIVATE' => '(نحن نعد للحفاظ على هذا خاصة)',
	'LBL_ALL_FIELDS_BELOW_ARE_REQUIRED' => '(جميع الحقول مطلوبة أدناه)',
	'LBL_GET_STARTED' => 'بدء',
	'LBL_YOUR_CONTACT_NUMBER' => 'الاتصال الخاصة بك رقم',
	'LBL_WHERE_ARE_YOU_FROM' => 'من أين أنت؟',
	'LBL_SELECT_COUNTRY' => 'اختر الدولة',
	'LBL_COMPANY_SIZE' => 'شركة الحجم',
	'LBL_JOB_TITLE' => 'المسمى الوظيفي',
	'LBL_DEPARTMENT' => 'قسم',
	'LBL_BASE_CURRENCY' => 'قاعدة العملات',
	'LBL_CHOOSE_BASE_CURRENCY' => 'اختيار العملة الأساسية',
	'LBL_OPERATING_CURRENCY' => 'العملة الأساسية التي لا يمكن تعديلها في وقت لاحق. اختر العملة التشغيل',
	'LBL_LANGUAGE' => 'لغة',
	'LBL_CHOOSE_LANGUAGE' => 'اختيار اللغة',
	'LBL_CHOOSE_TIMEZONE' => 'اختيار منطقة زمنية',
