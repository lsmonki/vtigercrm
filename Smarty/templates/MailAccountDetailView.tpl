   ...
   <td align="left">
     <table border="0" cellpadding="0" cellspacing="0" width="100%">
       ...
       <tr>
          ...
          <td class="dvtCellInfo" width="33%">{$DISPLAYNAME}</td>
       ...
       <tr>
          ...
          <td class="dvtCellInfo">{$SERVERNAME}</td>
       ...
       <tr>
		...
		<input type="radio" name="mailprotocol" value="imap" {$IMAP} readonly/>&nbsp;{$MOD.LBL_IMAP} 
		<input type="radio" name="mailprotocol" value="pop3" {$POP3} readonly/>&nbsp;{$MOD.LBL_POP} 
		<input type="radio" name="mailprotocol" value="imap2" {$IMAP2} readonly/>&nbsp;IMAP2
		<input type="radio" name="mailprotocol" value="IMAP4" {$IMAP4} readonly/>&nbsp;IMAP4
	   </td>	
           <td class="dvtCellInfo">&nbsp;</td>
        </tr>
        <tr>
           ...
           <td class="dvtCellInfo">
		<input type="radio" name="ssltype" value="notls" {$NOTLS} readonly/>&nbsp;No TLS
		<input type="radio" name="ssltype" value="tls" {$TLS} readonly/>&nbsp; TLS </td>
           <td class="dvtCellInfo">&nbsp;</td>
       </tr>
       <tr>
           <td class="dvtCellLabel" align="right">Certificate Validations </td>
           <td class="dvtCellInfo">
		<input type="radio" name="sslmeth" value="validate-cert" {$VALIDATECERT} readonly/>&nbsp;Validate SSL Cert
		<input type="radio" name="sslmeth" value="novalidate-cert" {$NOVALIDATECERT} readonly/>&nbsp;Don't Validate SSL Cert
	   </td>	
           <td class="dvtCellInfo">&nbsp;</td>
       </tr>
       <tr>
           ...
           <td class="dvtCellInfo">
		<select name="box_refresh" readonly>
       ...
       <tr>
           ...
           <td class="dvtCellInfo">{$MAILS_PER_PAGE}</td>
           <td class="dvtCellInfo">&nbsp;</td>
       </tr>
