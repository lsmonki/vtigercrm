...
<table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
	<tr>
		<td valign=top align=right><img src="themes/images/showPanelTopLeft.gif"></td>
		...
		<!-- Email Client starts here -->
			...
			<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="mailClient">
						...
						<table width="100%"  border="0" cellspacing="0" cellpadding="0">
							...
							&nbsp;<a href="index.php?module=Users&action=AddMailAccount&record={$USERID}" >{$MOD.LBL_SETTINGS}</a>
										...
										<td align=right>
											<table >
											<tr>
												<td class="componentName" align=right>{$MOD.LBL_VTIGER_EMAIL_CLIENT}<!-- <img src="themes/images/titleMailClient.gif" align="right"/> --></td>
											</tr>
											</table>
									</td>
									</tr>
				...
				<!-- <tr>
					<td width="7" height="8" style="font-size:1px;font-family:Arial, Helvetica, sans-serif;"><img src="themes/images/bottom_left.jpg" align="bottom"  /></td>
					<td bgcolor="#ECECEC" height="8" style="font-size:1px;" ></td>
					<td width="8" height="8" style="font-size:1px;font-family:Arial, Helvetica, sans-serif;"><img src="themes/images/bottom_right.jpg" align="bottom" /></td>
				</tr>-->
			</table><br/>
		</td>
