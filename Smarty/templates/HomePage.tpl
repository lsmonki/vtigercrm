...
<td width="25%" valign="top" style="padding:5px;">
	...
	<tr>
	<td width="13" height="70" background="{$IMAGE_PATH}pending_left.gif" ></td>
	<td width="91%" background="{$IMAGE_PATH}pendingEvents.gif" valign="bottom" style="background-repeat:repeat-x;">
