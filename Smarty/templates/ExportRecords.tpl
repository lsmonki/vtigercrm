...
<tr>
   ...
   <table  cellpadding="0" cellspacing="0" width="100%" border=0>
	 		...
	 		<table>
			   <tr>
			       <td colspan="2" align="left" valign="top" style="padding-left:40px;">
		    	       <span class="genHeaderSmall">{$APP.LBL_SEARCH_CRITRIA_RECORDS}:</span> </td>
			   </tr>
		  	   <tr>
	...
	<td align="center" colspan="2" border=0 cellspacing=0 cellpadding=5 width=98% class="layerPopupTransport">	
			<input type="button" name="{$APP.LBL_EXPORT}" value="{$APP.LBL_EXPORT} {$MODULE} " class="crmbutton small create" onclick="record_export('{$MODULE}','{$CATEGORY}',this.form)"/>&nbsp;&nbsp;
