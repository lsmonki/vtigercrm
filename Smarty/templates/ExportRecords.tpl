...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="98%" class="small" >
<tr>
   ...
   <table  cellpadding="0" cellspacing="0" width="100%" border=0>
	...
	<table align="center" cellpadding="15" cellspacing="0" width="85%" class="mailClient importLeadUI small" border="0">
 	<tr>
     		<td colspan="2" valign="middle" align="left" class="mailClientBg  genHeaderSmall">{$MODULE} >> {$APP.LBL_EXPORT} </td>
	</tr>
	<tr>
	 		...
	 		<table>
			   <tr>
			       <td colspan="2" align="left" valign="top" style="padding-left:40px;">
		    	       <span class="genHeaderSmall">{$APP.LBL_SEARCH_CRITERIA_RECORDS}:</span> </td>
			   </tr>
		  	   <tr>
				<td align="right" valign="top" width="50%" class=small>{$APP.LBL_WITH_SEARCH}</td>
				<td  align="left" valign="top" width="5%" class=small>
                   		<input type="radio" name="search_type" checked value="includesearch"></td>
			   </tr>
			   <tr>
				<td align="right" valign="top" width="50%" class=small>{$APP.LBL_WITHOUT_SEARCH}</td>	
				<td align="left" valign="top" width="5%" class=small>
	                 	<input type="radio" name="search_type" value="withoutsearch"></td>
			   </tr>
			   <tr>
				<td colspan="2" align="left" valign="top" style="padding-left:40px;">
				<span class="genHeaderSmall">{$APP.LBL_EXPORT_RECORDS}:</span></td>
			   </tr>
			   <tr>
				<td align="right" valign="top" width="50%" class=small>{$APP.LBL_ALL_DATA}</td>
				<td align="left" valign="top" width="5%" class=small>
				<input type="radio" name="export_data" checked value="all"></td>
			   </tr>
			   <tr>
			        <td align="right" valign="top" width="50%" class=small >{$APP.LBL_DATA_IN_CURRENT_PAGE}</td>
				<td align="left" valign="top" width="5%" class=small>
				<input type="radio" name="export_data" value="currentpage"> </td>
			   </tr>
			   <tr>
		   	       <td align="right" valign="top" width="50%" class=small >{$APP.LBL_ONLY_SELECTED_RECORDS}</td>
		   		<td align="left" valign="top" width="5%" class=small>
		   		<input type="radio" name="export_data" value="selecteddata"></td>
		   	   </tr>
			</table>
		</td>
		<td table border="0" cellpadding="5" cellspacing="0" width="50%">
			<table >
			<tr>		
	...
	<td align="center" colspan="2" border=0 cellspacing=0 cellpadding=5 width=98% class="layerPopupTransport">	
			<input type="button" name="{$APP.LBL_EXPORT}" value="{$APP.LBL_EXPORT} {$MODULE} " class="crmbutton small create" onclick="record_export('{$MODULE}','{$CATEGORY}',this.form,'{$smarty.request.idstring}')"/>&nbsp;&nbsp;
