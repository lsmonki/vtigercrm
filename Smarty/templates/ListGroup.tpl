...
<tbody><tr>
	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="themes/images/ico-groups.gif" alt="{$MOD.LBL_GROUPS}" width="48" height="48" border=0 title="{$MOD.LBL_GROUPS}"></td>
					...
					<tr>
					  ...
					  <tr>
						...
						<td class="listTableRow small" valign=top nowrap>
							  	<a href="index.php?module=Settings&action=createnewgroup&returnaction=listgroups&parenttab=Settings&mode=edit&groupId={$groupvalues.groupid}"><img src="themes/images/editfield.gif" alt="{$APP.LNK_EDIT}" title="{$APP.LNK_EDIT}" border="0" align="absmiddle"></a>&nbsp;|	
								<a href="#" onClick="deletegroup(this,'{$groupvalues.groupid}')";><img src="themes/images/delete.gif" alt="{$LNK_DELETE}" title="{$APP.LNK_DELETE}" border="0" align="absmiddle"></a>
						</td>
