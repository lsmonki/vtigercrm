...
<form action="index.php" method="post" name="ListLoginHistory" id="form">
...
<input type='hidden' name='parenttab' value='Settings'>
	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="themes/images/set-IcoLoginHistory.gif" alt="{$MOD.LBL_AUDIT_TRAIL}" width="48" height="48" border=0 title="{$MOD.LBL_LOGIN_HISTORY_DETAILS}"></td>
