		...
		<table border=0 cellspacing=0 cellpadding=5 width=100% class="tableHeading">
		   ...
		   <tr>
			...
			{if $EDIT_MODE eq 'true'}	
				...
				<input class="crmButton small cancel" title="{$APP.LBL_CANCEL_BUTTON_TITLE}" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" onclick="this.form.action.value='TaxConfig'; this.form.module.value='Settings'; this.form.parenttab.value='Settings';" type="button" name="button22" value="  {$APP.LBL_CANCEL_BUTTON_LABEL}  ">
			{elseif $TAX_COUNT > 0}
