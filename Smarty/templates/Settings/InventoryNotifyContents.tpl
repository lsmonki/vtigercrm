...
<table width="100%" cellpadding="5" cellspacing="0" class="listTable" >
	...
	<td class="listTableRow small" align="center" ><img onClick="fnvshobj(this,'editdiv');fetchEditNotify('{$elements.id}');" style="cursor:pointer;" src="themes/images/editfield.gif" title="{$APP.LBL_EDIT}"></td>
	</tr>
	{/foreach}
	</table>
