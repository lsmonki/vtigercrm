...
<br>
	<div align=center>
			...
			<tr>
				<td width="50" rowspan="2" valign="top"><img src="themes/images/notification.gif" alt="{$MOD.LBL_MODULE_NAME}" width="48" height="48" border=0 title="{$MOD.LBL_MODULE_NAME}"></td>
