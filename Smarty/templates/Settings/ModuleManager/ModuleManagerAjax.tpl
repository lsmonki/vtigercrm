...
<tr>
	...
	<td class="cellText small" width="15px" align=center>
		<a href="index.php?module=Settings&action=ModuleManager&module_settings=true&formodule={$modulename}&parenttab=Settings"><img src="{$IMAGE_PATH}Settings.gif" border="0" align="absmiddle" alt="{$modulename} {$MOD.LBL_SETTINGS}" title="{$modulename} {$MOD.LBL_SETTINGS}"></a>
	</td>
</tr>
{/foreach}
</table>
