...
{foreach key=langprefix item=langinfo from=$TOGGLE_LANGINFO}
	...
	<tr>
		...
		<td class="cellText small" width="15px" align=center>
			<a href="index.php?module=Settings&action=ModuleManager&module_update=Step1&src_module={$langprefix}&parenttab=Settings"><img src="{$IMAGE_PATH}reload.gif" border="0" align="absmiddle" alt="{$MOD.LBL_UPGRADE} {$langinfo.label}" title="{$MOD.LBL_UPGRADE} {$langinfo.label}"></a>
		</td>
		<td class="cellText small" width="15px" align=center>
