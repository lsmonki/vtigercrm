					     ...
					     <td style="padding:10px">
							...
							<td  colspan=4 style="padding:5px">
						     ...
						     <table border=0 cellspacing=0 cellpadding=5 width=90% >
								...
								<td width=80%>{$ACTIVITYDATA.activitytype}</td>
							 </tr>
							 <tr>
						     ...
						     <table border=0 cellspacing=0 cellpadding=5 width=90% >
                                                         <tr>
                                                                <td align="right"><b>{$LABEL.createdtime} :</b></td>
                                                                <td >{$ACTIVITYDATA.createdtime}</td>
                                                                <td align="right"><b>{$LABEL.modifiedtime} :</b></td>
							 ...
							 <tr>
									...
									<tr>
											...
											<tr><td colspan=3>{$ACTIVITYDATA.starthr}:{$ACTIVITYDATA.startmin}{$ACTIVITYDATA.startfmt}</td></tr>
											...
											<tr><td colspan=3>{$ACTIVITYDATA.endhr}:{$ACTIVITYDATA.endmin}{$ACTIVITYDATA.endfmt}</td></tr>
                					 ...
                					 <tr>
                        					<td><b>{$MOD.Priority}</b>&nbsp;:&nbsp;{$ACTIVITYDATA.priority}</td>
							 </tr>
						     </table>
						     <br>
							...
							<tr>
								...
								<td width="80%">{$ACTIVITYDATA.task_subject}</td>
							</tr>
							<tr>
								<td><b>{$MOD.LBL_TIMEDATE} :</b></td>
								<td>{$ACTIVITYDATA.starthr}:{$ACTIVITYDATA.startmin}{$ACTIVITYDATA.startfmt}</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>{$ACTIVITYDATA.task_date_start}</td>
							</tr>
							<tr>
								<td><b>{$LABEL.taskpriority}&nbsp;:&nbsp;</b></td>
								<td>{$ACTIVITYDATA.priority}</td>
							</tr>
						    </table>
						    <table border=0 cellspacing=0 cellpadding=5 width=90% >
                                                         <tr>
