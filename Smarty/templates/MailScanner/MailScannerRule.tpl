	         	    ...
	         	    <td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
						...
						<tr>
							<td nowrap class="small cellLabel">
								...
								{if $NEXT_RULEID}
<a href="index.php?module=Settings&action=MailScanner&parenttabl=Settings&mode=rulemove_down&scannername={$SCANNERINFO.scannername}&targetruleid={$NEXT_RULEID}&ruleid={$SCANNERRULE->ruleid}" title="{$MOD.LBL_MOVE} {$MOD.LBL_DOWN}"><img src="{$IMAGE_PATH}arrow_down.gif" border=0></a>
								{/if}
								{if $PREV_RULEID}
<a href="index.php?module=Settings&action=MailScanner&parenttabl=Settings&mode=rulemove_up&scannername={$SCANNERINFO.scannername}&targetruleid={$PREV_RULEID}&ruleid={$SCANNERRULE->ruleid}" title="{$MOD.LBL_MOVE} {$MOD.LBL_UP}"><img src="{$IMAGE_PATH}arrow_up.gif" border=0></a>
								{/if}
								</span>
							</td>
